     ...
     #  ibeam1,dist1,ener1, nptype1, nngroup1, nnset1,
     #  ibeam2,dist2,ener2, nptype2, nngroup2, nnset2,
...
c jprefix is last non-blank in prefix
     ...
     #     ,nngroup1,nngroup2,nnset1,nnset2,icalctype
      real * 8 dist1,dist2,ener1,ener2,xmq,xxlam,ffact,fren,pt,ylab
...
c common for nuclear structure functions (see fonllmlmpdf in fonllpdf.f)
      ...
      common/shadowing/distance1
      common/shadowing/distance2
...
c Cross section in pb/GeV^2
     ...
     #             (pt**2+(csmear*xmq)**2)
      ...
      elseif(ibeam.eq.-1) then
         cbeam='pr-'
      elseif(ibeam.eq.100) then
         cbeam='aa+'
      elseif(ibeam.eq.200) then
         cbeam='bb+'
      ...
      elseif(cbeam.eq.'pr-') then
         ibeam=-1
      elseif(cbeam.eq.'aa+') then
         ibeam=100
      elseif(cbeam.eq.'bb+') then
         ibeam=200
