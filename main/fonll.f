...
c jprefix is last non-blank in prefix
     ...
     # ,icalctype
      real * 8 ener1,ener2,dist1,dist2,xmq,xlam,ffact,fren,pt,ylab
...
c
      write(*,*)
      write(*,*) 'enter beam 1 type, dist, energy, 3 pdf numbers'
      read(*,*)  ibeam1, dist1, ener1, nptype1, ngroup1, nset1
      write(itm,*) ibeam1, dist1, ener1, nptype1, ngroup1, nset1,
     # ' ! beam1: type, ener.,  nptype, ngroup, nset'
      write(*,*)
      write(*,*) 'enter beam 2 type, dist, energy, 3 pdf numbers'
      read(*,*)  ibeam2, dist2, ener2, nptype2, ngroup2, nset2
      write(itm,*) ibeam2, dist2, ener2, nptype2, ngroup2, nset2,
...
c End of input
     ...
     #  ibeam1,dist1,ener1, nptype1, ngroup1, nset1,
     #  ibeam2,dist2,ener2, nptype2, ngroup2, nset2,
